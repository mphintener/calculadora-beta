...
# CSS: ESTILO DE ALTO IMPACTO (PRETO, AMARELO NEON E VERMELHO)
st.markdown("""
    <style>
...
# 1. BASE GEOGRÁFICA INTEGRAL (96 DISTRITOS + 38 MUNICÍPIOS)
geo_db = {
...
with st.form("beta_calc"):
    ...
    with col3: dias_trecho = st.number_input("📅 DIAS NO TRECHO/MÊS:", min_value=1, max_value=31, value=22)
...
if btn and sal > 0:
    h_paga = 176
    custo_t_mensal = (p_pub + p_app + p_car) * dias_trecho
    ...
    # MAPA COM DESIGN DE "PONTO DE CALOR" (ADEUS FÓSFORO)
