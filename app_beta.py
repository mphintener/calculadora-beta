...
# BASE DE DADOS GEO (DISTRITOS + RMSP COMPLETA)
# Atualizada com coordenadas precisas para Barra Funda e Pinheiros
geo_db = {
    "São Paulo (Centro)": [-23.5505, -46.6333], "Barra Funda": [-23.5255, -46.6669], 
    "Pinheiros": [-23.5611, -46.7011], "Caieiras": [-23.3644, -46.7411], 
    ...
    "Lapa": [-23.5222, -46.7028], "Santana": [-23.5015, -46.6233]
}
# Nota: Você pode continuar adicionando outros distritos seguindo este padrão: "Nome": [Lat, Lon]
...
with st.form("beta_calc"):
    ...
    with col2: vida = st.number_input("🏠 CUSTO VIDA:", min_value=0.0, help="Preenchimento Opcional: Gastos fixos para calcular a sobra real.")
